...
public class SwipeLayout extends FrameLayout {
    ...
    public SwipeLayout(Context context, AttributeSet attrs) {
        ...
        int ordinal = ta.getInt(R.styleable.SwipeLayout_show_mode, ShowMode.LayDown.ordinal());
    ...
    ViewDragHelper.Callback mCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            if (mShowMode == ShowMode.LayDown){
                // 对deleteView重新布局
                deleteView.layout(contentViewWidth - deleteViewWidth, deleteView.getTop(), contentViewWidth, deleteView.getBottom());
            }else{
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        if (mShowMode == ShowMode.LayDown){
            ...
            deleteView.layout(right - deleteViewWidth, top, deleteViewWidth, bottom);
